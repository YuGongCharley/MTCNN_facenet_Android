 ...
 * 相机界面SurfaceView的回调类
 */
public final class AddSurfaceViewCallback implements SurfaceHolder.Callback, Camera.PreviewCallback {
...
//            setCameraDisplayOrientation(MainActivity.this, FrontCamera.mCurrentCamIndex, mCamera);
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        mFaceTask = new FaceAddTask(data, camera);
